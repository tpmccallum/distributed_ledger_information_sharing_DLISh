...
If the encoded and encrypted address used at the start of this document is stored 5 million times on the blockchain it will take up less than 1GB (around 0.75GB)
